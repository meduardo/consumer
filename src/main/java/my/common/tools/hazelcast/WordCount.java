package my.common.tools.hazelcast;
...
public class WordCount {
    ...
    public static void main(String[] args) {
        ...
        source.put(1, "There were a king with a large jaw and a queen with a plain face, on the that things in general were settled for ever.");
        source.put(2, "It was the year of Our Lord one thousand seven hundred and seventy-five. Spiritual revelations were conceded to England at that favoured period");
